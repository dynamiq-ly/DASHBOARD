...
import { getProduct, newProduct, resetProduct, selectProduct } from '../store/location-slice'
...
const schema = yup.object().shape({
  label: yup.string().required('Age Group is required').min(3, 'The Age Group is too short!'),
})
...
export default withReducer('locations', reducer)(Element)

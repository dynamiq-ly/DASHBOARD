...
import MedicalAssistanceTableHead from './MedicalAssistanceTableHead'

function MedicalAssistanceTable(props) {
...
export default withRouter(MedicalAssistanceTable)

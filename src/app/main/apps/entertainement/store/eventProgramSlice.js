...
export const getMeasures = createAsyncThunk(
  'eventPrograms/eventProgram/getMeasures',
  async () => {
...
export const { selectAll: selectProducts, selectById: selectProductById } =
  measuresAdapter.getSelectors((state) => state.eventPrograms.eventProgram)

const safetySlice = createSlice({
  name: 'eventPrograms/eventProgram',
...
export const selectProductsSearchText = ({ eventPrograms }) =>
  eventPrograms.eventProgram.searchText

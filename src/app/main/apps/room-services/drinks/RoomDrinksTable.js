...
import { getMeasures, selectProducts, selectProductsSearchText } from '../store/drinksSlice'
import RoomDrinksTableHead from './RoomDrinksTableHead'
          ...
          <TableBody>
            {_.orderBy(
              ...
              [
                (o) => {
                  switch (order.id) {
                    case 'drink_drink_category': {
                      return o[order.drink_drink_category]
                    }
                    default: {
                      return o[order.id]
                    }

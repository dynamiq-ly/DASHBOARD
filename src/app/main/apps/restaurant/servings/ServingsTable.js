...
import { getMeasures, selectProducts, selectProductsSearchText } from '../store/servingsSlice'
import ServingsTableHead from './ServingsTableHead'
    ...
    if (searchText.length !== 0) {
      setData(
        _.filter(products, (item) =>
          item.serving_name.toLowerCase().includes(searchText.toLowerCase())
        )
      )
      setPage(0)
    } else {
              ...
              .map((n) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="p-4 md:p-16 truncate" component="th" scope="row">
                      {n.serving_opens} - {n.serving_closes}
                    </TableCell>
                  </TableRow>
                )
              })}

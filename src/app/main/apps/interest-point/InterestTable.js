...
import { getMeasures, selectProducts, selectProductsSearchText } from './store/pointsSlice'
    ...
    if (searchText.length !== 0) {
      setData(
        _.filter(products, (item) =>
          item.point_title.toLowerCase().includes(searchText.toLowerCase())
        )
      )
      setPage(0)
    } else {

...
import { getProduct, newProduct, resetProduct, selectProduct } from '../store/assign-addon-slice'
...
function RoomCategory(props) {
  ...
  useDeepCompareEffect(() => {
    function updateProductState() {
      ...
      if (addonsId === 'new') {
         ...
         * Get Product data
         */
        dispatch(getProduct(addonsId)).then((action) => {
          /**
  ...
  if (
    _.isEmpty(form) ||
    (product && routeParams.addonsId !== `${product.id}` && routeParams.addonsId !== 'new')
  ) {
    return <FuseLoading />
  }

          ...
          >
            <div className="flex flex-auto w-full items-center justify-center">
              <img
                ...
                src={`${process.env.REACT_APP_STORAGE_UTELLS}/rooms/room-add-ons/${el.addon.image}`}
              />
            </div>
            <div className="flex shrink flex-col justify-center text-center">
              <Typography className="truncate text-12 font-medium">{el.addon.label}</Typography>
            </div>
          </NavLinkAdapter>
        </Box>
      ))}

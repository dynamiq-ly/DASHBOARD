    ...
    if (searchText.length !== 0) {
      setData(
        _.filter(products, (item) =>
          item.reminder_title.toLowerCase().includes(searchText.toLowerCase())
        )
      )
      setPage(0)
    } else {
            ...
            {_.orderBy(
              ...
              [
                (o) => {
                  switch (order.id) {
                    case 'reminder_title': {
                      return o[order.reminder_title]
                    }
                    case 'reminder_user': {
                      return o[order.reminder_user]
                    }
                    default: {
                      return o[order.id]
                    }
              ...
              .map((n) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell className="p-4 md:p-16 truncate" component="th" scope="row">
                      <StatusBade name={n.reminder_priority} />
                      {/* {n.reminder_priority} */}
                    </TableCell>

                    <TableCell className="p-4 md:p-16 truncate" component="th" scope="row">
                      {n.reminder_user || <p>TEST</p>}
                    </TableCell>
...
export default withRouter(AlarmTable)
